...
class Question (db.Model):
    ...
    questionnaire_id = db.Column(db.Integer, db.ForeignKey("questionnaire.id"))  # Add this ForeignKey
...
class User(db.Model, UserMixin):
    ...
    question_id = db.Column(db.Integer, db.ForeignKey("question.id"))  # ForeignKey to Question
