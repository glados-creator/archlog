$(function() {
    ...
    function remplirTaches(repjson) {
      ...
      function onerror(err) {
          $("#Qquestionnaires").html("<b>Impossible de récupérer les taches à réaliser !</b>"+err);
      }

    function refreshTaskList(){
        $("#currenttask").empty();
        requete = "http://127.0.0.1:5000/quizz/api/v1.0/questionnaire";
        fetch(requete)
        .then( response => {
